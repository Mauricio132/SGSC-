<nav class="navbar navbar-blue navbar-fixed-top" role="navigation" style="background: #3f51b5">
    ...
    <div class="navbar-header">
        <div class="left_col">
            <div class="col-lg-12">
                <div class="col-lg-3" >
                    <img class="img-rounded logomain" width=75px" height="40px" src="../../static/img/menu/iconofinal.png" />
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <ul class="nav navbar-nav">
            <li class="active"><a href="../inicio/admin.php"><span class="glyphicon glyphicon-home"></span> Comercial ALFACACAO</a></li>
