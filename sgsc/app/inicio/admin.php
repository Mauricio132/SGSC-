...
<!--                                <a href="wpersonal.php?action=tabla" class="icon well sbox">
                                ...
                                <a href="warticulo.php?action=tabla" class="icon well sbox">
                                    ...
                                    <div class="iconname">
                                        <div class="pd">
                                            <h4 class="tituloicon">Inventario Cacao</h4>
                                            <span class="icondesc">Administración de invent.Cacao</span>
                                        </div>
                                    </div>
                                </a>
                                <a href="wcategoriaArticulo.php?action=tabla" class="icon well sbox">
                                    ...
                                    <div class="iconname">
                                        <div class="pd">
                                            <h4 class="tituloicon">Tipo de Cacaos</h4>
                                            <span class="icondesc">Administración de Tipo de Cacaos</span>
                                        </div>
                                    </div>
                                </a>
                                ...
                                <a href="../../app/vista/vVentaEstable.php" class="icon well sbox">
                                    ...
                                    <div class="iconname">
                                        <div class="pd">
                                            ...
                                            <span class="icondesc">Facturación de Cacao</span>
                                        </div>
                                    </div>
                                </a>
                                <a href="../../app/vista/vCompra.php" class="icon well sbox">
                                    ...
                                    <div class="iconname">
                                        <div class="pd">
                                            ...
                                            <span class="icondesc">Compra de Cacao</span>
                                        </div>
                                    </div>
                                </a>
