                    ...
                    <div class="row-fluid">
                        <div class="span12">
                            <ul class="breadcrumb">
                                ...
                                <li><a href="javascript:window.location.reload();" class="active">Categoria Articulo</a> <span class="divider">/</span></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-md-12">
                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col col-xs-3">
                                        <h3>Listado de Tipo de Cacaos</h3>
                                    </div>                                    
                                </div>
                                <br>
                                <div class="row">
...
<!--                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="x" placeholder="Buscar Categoria Articulos">
                                    ...
                                    <div class="col col-xs-6 text-right">
                                        <div class="btn-group">
                                            <a class="btn btn-success" href="../ajax/categoriaArticuloAjax.php?action=nuevo">
            ...
            $(function () {
                $('#tdatos #tdetalle').on('click', 'a[rel="action"]', function () {
                    ...
                    if(data.action === 'editar'){
                        window.location ='../ajax/categoriaArticuloAjax.php?action=editar&id='+data.id; 
                    }else{
                        $.ajax({
                            url:'../ajax/categoriaArticuloAjax.php',
                            type: 'POST',
                            ...
                            if(data.resp){
                                alert("Eliminado");
                               window.location ='wcategoriaArticulo.php?action=tabla'; 
                            }else{
                                alert(data.error);
                            }
                        });
