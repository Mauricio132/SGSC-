                                            ...
                                            <form id="frm-provincia" class="form-horizontal">
                                                <div class="row-fluid">
                                                    ...
                                                    <div class="item form-group">
                                                        ...
                                                        <div class="col-xs-7">
                                                            <input placeholder="nombre" required="required" name="nombre" type="text" class="form-control" value="<?= $this->model->nombre ?>"pattern="[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]{1,100}" >
                                                        </div>                                                        
                                                    </div> 
                                                    ...
                                                    <div class="item form-group">
                                                        ...
                                                        <div class="col-xs-7">
                                                            <textarea pattern="[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]{1,100}" required="required" name="descripcion" class="form-control" placeholder="Ingrese Descripcion"><?= $this->model->descripcion ?></textarea>
                                                        </div>                                                        
                                                    </div> 
                                                    <div class="item form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="control-label col-xs-2">Costo por Libra</label> 
                                                        <div class="col-xs-3">
                                                            <div class="input-group">
                                                                <input required="required" name="costo" class="form-control" type="number" placeholder="0.00" value="<?= $this->model->costo; ?>">
                                                                <span class="input-group-addon"><i class="glyphicon glyphicon-usd"></i></span>
                                                            </div>  
                                                        </div>
                                                        <label class="control-label col-xs-2">Precio por Libra</label> 
                                                        <div class="col-xs-3">
                                                            <div class="input-group">
                                                                <input required="required" name="precio" class="form-control" type="number" placeholder="0.00" value="<?= $this->model->precio; ?>">
                                                                <span class="input-group-addon"><i class="glyphicon glyphicon-usd"></i></span>
                                                            </div>  
                                                        </div>
                                                    </div>
                                                ...
                                                <div class=" form-group">
                                                    <label class="control-label col-xs-2">Libras</label> 
                                                    <div class="col-xs-3">
                                                        <div class="input-group">
                                                    ...
                                                    <label class="control-label col-xs-2">Libras Minimo</label> 
                                                    <div class="col-xs-3">
                                                        <div class="input-group">
